...
public class AmazonProductManager {
	...
	public void saveProductList() { // Saves the current product list to a file or database
		...
		productList.saveList(newFileName);      // should add a if statement for if the file fails to write/save
	...
	public void showMenu() {
		...
		while (true) {
             ...
             try {
            	 ...
            	 AmazonProductException invalidinput = new AmazonProductException ("Invalid input! Please enter a number between 0 and 7.");
                 System.err.println(invalidinput);
                 input.nextLine(); // Clear the invalid input
                 continue; // Go back to the start of the try catch
             }
            ...
            case 7:
                ...
                break;
            default:
                System.out.println("Place Holder"); // we should be able to get rid of this but will wait to see what you think daniel 
	        }
