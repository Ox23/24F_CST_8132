...
public class AmazonProductUtil {
	...
	public float convertStrToFloat(String str) {
	    ...
	    try {
	    	...
	    	AmazonProductException Numbform = new AmazonProductException ("Error converting string to float:");  // adds AmazonProductException
	        System.err.println(Numbform + str);  // print error if conversion fails
	        return 0.0f;
	    }
	}
